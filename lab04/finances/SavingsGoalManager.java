...
public class SavingsGoalManager {
    ...
    public static void showDialog(JFrame parent, Connection conn) {
        createGoalTableIfNotExists(conn);
    ...
    private static void createGoalTableIfNotExists(Connection conn) {
    ...
    private static void loadGoalsToTable(Connection conn, DefaultTableModel model) {
        model.setRowCount(0);
    ...
    private static double getCurrentBalance(Connection conn) {
    ...
    private static void showGoalDialog(JDialog parent, Connection conn, Integer goalId) {
    ...
    private static void deleteGoal(Connection conn, int goalId) {
